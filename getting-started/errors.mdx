...
```json
{
  "ok": false,
  "error": {
    "code": "sid_market_rule_violation",
    "message": "Sender ID 'BANK' is a restricted term in market AU.",
    "param": "sender_id",
    "doc_url": "https://developers.senderz.ai/errors/sid_market_rule_violation"
  },
  "meta": {
